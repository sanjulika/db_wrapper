...
print_r($res->find('organizations', 'all', array('conditions' => 'id > 10', 'limit' => '10')));

echo '<br/>List Organization whose id is greater than 10 and less than equal to 50<br/>';

print_r($res->find('organizations', 'all', array('conditions' => 'id BETWEEN 10 AND 50')));

echo '<br/> List all organization who has been created after 2013-02-10 00:00:00<br/>';

print_r($res->find('organizations', 'all', array('conditions' => 'created_on > "2013-02-10 00:00:00"')));

echo '<br/>List all organizations who has id between 10 to 50 and its orders should be descending by name<br/>';

print_r($res->find('organizations', 'all', array('conditions' => 'id BETWEEN 10 AND 50', 'order' => 'name,DESC')));

echo '<br/>Display informations about organization whose id is 70<br/>';

print_r($res->find('organizations', 'all', array('conditions' => 'id = 70')));

echo '<br/>display informations about organization whose name is "Org Name 30"<br/>';

print_r($res->find('organizations', 'all', array('conditions' => 'name = "Org Name 30"')));

echo '<br/>display all the users of organization_id 30<br/>';

print_r($res->find('users', 'all', array('conditions' => 'organisation_id = 30')));
